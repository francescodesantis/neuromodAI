...
#SBATCH --error=best_models/STL10_IMG/job.err            # standard error file
#SBATCH --output=best_models/STL10_IMG/job.out           # standard output file
...
mv Training/results/hebb/result/network/STL10_ImageNette_CL/checkpoint.pth.tar Training/results/hebb/result/network/STL10_ImageNette_CL/models/checkpoint.pth.tar
