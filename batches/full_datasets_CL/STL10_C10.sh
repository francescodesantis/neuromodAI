...
#SBATCH --error=best_models/STL10_C10/job.err            # standard error file
#SBATCH --output=best_models/STL10_C10/job.out           # standard output file
...
mv Training/results/hebb/result/network/STL10_CIFAR10_CL/checkpoint.pth.tar Training/results/hebb/result/network/STL10_CIFAR10_CL/models/checkpoint.pth.tar
