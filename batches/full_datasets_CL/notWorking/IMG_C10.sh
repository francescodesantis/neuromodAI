...
rm -rf -d Training/results/hebb/result/network/ImageNette_CIFAR10_CL
cp -r Training/results/hebb/result/network/ImageNette_Best Training/results/hebb/result/network/ImageNette_CIFAR10_CL
rm -rf -d Training/results/hebb/result/network/ImageNette_CIFAR10_CL/models
mkdir Training/results/hebb/result/network/ImageNette_CIFAR10_CL/models
cp Training/results/hebb/result/network/ImageNette_CIFAR10_CL/checkpoint.pth.tar Training/results/hebb/result/network/ImageNette_CIFAR10_CL/models/checkpoint.pth.tar
