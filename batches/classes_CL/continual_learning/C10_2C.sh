...
conda run -n softhebb python continual_learning.py --preset 4SoftHebbCnnCIFAR --resume all --model-name 'C10_2C_CL' --dataset-unsup CIFAR10_1 --dataset-sup CIFAR10_50 --continual_learning True --evaluate True --classes 2
