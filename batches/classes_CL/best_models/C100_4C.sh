...
conda run -n softhebb python ray_search_cl.py --preset 4SoftHebbCnnCIFAR --resume all --model-name 'C100_4C_Best' --dataset-unsup CIFAR100_1 --dataset-sup CIFAR100_50 --continual_learning True --evaluate True --classes 4
