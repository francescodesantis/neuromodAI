...
conda run -n softhebb python ray_search_cl.py --preset 6SoftHebbCnnImNet --resume all --model-name 'IMG_4C_Best' --dataset-unsup ImageNette_1 --dataset-sup ImageNette_50 --continual_learning True --evaluate True --classes 4
