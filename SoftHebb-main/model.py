...
class MultiLayer(nn.Module):
    ...
    def __init__(self, blocks_params: dict, blocks: nn.Module = None, topk_kernels: dict = {}, avg_deltas: dict = {}, heads: list = [], cl_hyper: dict = {}) -> None:
        super().__init__()
                ...
                if params['arch'] == 'CNN':
                    ...
                    if len(self.topk_kernels) > 0:
                        ...
                        if layer_num == depth: 
                            ...
                            if self.cl_hyper["t_criteria"] == "KSE" and layer_num <= (depth-2):
